...
class GATv2L1(Processor):
    ...
    def __call__(  # pytype: disable=signature-mismatch  # numpy-scalars
        ...
        sigmas = jnp.exp(logits + bias_mat)
        res = jnp.matmul(sigmas, values)
        sums = jnp.sum(sigmas, axis=-1, keepdims=True)
        ret = res / sums
...
class PGNL1(Processor):
    ...
    def __call__(  # pytype: disable=signature-mismatch  # numpy-scalars
        ...
        """MPNN inference step.
    Level 1 of asynchrony-invariant GNNs:
